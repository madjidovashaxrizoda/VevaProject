...
export default function LocationBtnPhone() {
  ...
  return (
    <div className="max-w-full hidden pt-5 w-full pr-6 md:pt-2.5 max-[650px]:block">
      <button onClick={toggleDropdown} className="text-black bg-white font-normal rounded-lg text-sm px-4 py-2 text-center flex gap-1 items-center w-full">
	  <svg
        ...
        <p className="w-full text-start pl-3">Beshyogoch 28-3</p>
        <svg
      ...
      {isDropdownVisible && (
        <div className="z-10 bg-white divide-y divide-gray-100 absolute top-30 rounded-lg shadow-lg w-10/12">
          <ul className="py-2 text-sm text-gray-700 dark:text-gray-200">
            <li onClick={toggleDropdown}>
              <button className="block px-4 py-2 hover:bg-gray-100 focus:bg-blue-50">
